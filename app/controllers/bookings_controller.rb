class BookingsController < ApplicationController
    def create
        ...
        @amount_to_be_paid = params[:no_of_tickets].to_i * @workshop.registration_fees
        ...
        @booking = @workshop.bookings.new(
            ...
            strip_transaction_id: @charge.id,
        ...
        if @booking.save
            ...
            redirect_to workshop_path(@workshop),notice:"ticket books"
        else
            @stripe_service.create_stripe_refund(@charge.id)
            redirect_to workshop_path(@workshop),notice:"booking failed"
        end
    ...
    def customer_params
        params.permit(:full_name,:contact_no,:email)
    end
